...
- [x] Create ticket workspace and baseline documents
- [x] Add ordered investigation scripts and SQL queries under `scripts/`
- [x] Inspect current mirror, enrichment, server, and UI code paths
- [x] Run ticket evidence scripts against an enriched mailbox mirror
- [x] Write detailed analysis, design, and implementation guide
- [x] Write MVP fast-path design doc for quick implementation
- [x] Write investigation diary with commands, evidence, and decisions
