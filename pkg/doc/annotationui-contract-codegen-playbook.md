...
Put new schema files under `proto/smailnail/annotationui/v1/`. Reuse the existing package and go package:
...
- Go: `pkg/gen/smailnail/annotationui/v1/`
- TypeScript: `ui/src/gen/smailnail/annotationui/v1/`
